...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO leaves (emp_id, leave_from, leave_to, reason) 
            VALUES (:emp_id, :leave_from, :leave_to, :reason)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute(['emp_id' => $emp_id, 'leave_from' => $leave_from, 'leave_to' => $leave_to, 'reason' => $reason]);

...
// Insert position (POST method)
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    $pos_name = $_POST['pos_name'];
    $salary = $_POST['salary'];

    $sql = "INSERT INTO positions (pos_name, salary) VALUES (:pos_name, :salary)";
    $stmt = $pdo->prepare($sql);
    $stmt->execute(['pos_name' => $pos_name, 'salary' => $salary]);
...
<head>
    ...
    <title>Position Management | EMS Pro</title>
...
<body>
    <div class="container">
        ...
        <div class="navbar">
            ...
            <a href="position.php" class="active"><i class="fas fa-user-tie"></i> Positions</a>
        ...
        <h1><i class="fas fa-user-tie"></i> Position Management</h1>

        <!-- Add Position Form -->
        <form method="POST" action="position.php">
            <div class="form-group">
                <label for="pos_name">Position Name</label>
                <select id="pos_name" name="pos_name" required>
    ...
    <option value="Financial Analyst">Financial Analyst</option>
            ...
            <div class="form-group">
                ...
                <input type="number" id="salary" name="salary" placeholder="Enter base salary" min="0" step="0.01" required>
            </div>
            <button type="submit"><i class="fas fa-plus-circle"></i> Add Position</button>
        </form>
        ...
        <table>
            ...
            <tbody>
                <?php if (!empty($positions)): ?>
                    ...
                    <tr>
                        <td><?php echo htmlspecialchars($position['pos_name']); ?></td>
                        <td class="currency">$<?php echo number_format($position['salary'], 2); ?></td>
                        <td>
                            <a href="edit_position.php?id=<?php echo $position['pos_id']; ?>" class="action-link">
